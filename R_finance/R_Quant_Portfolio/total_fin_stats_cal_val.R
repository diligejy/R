...
for (i in 1 : nrow(KOR_ticker)){
  ...
  # 재무제표 저장
  write.csv(data_fs, paste0('C:/Users/jinyoung/Desktop/R_finance/R_Quant_Portfolio/data/KOR_fs/', name, '_fs.csv'))
  
  # 가치지표 저장
  write.csv(data_value, paste0('C:/Users/jinyoung/Desktop/R_finance/R_Quant_Portfolio/data/KOR_value/', name,
                               '_value.csv'))
